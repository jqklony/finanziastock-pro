    ...
    <div className="min-h-screen bg-gradient-to-br from-[#003366] to-[#0078B4] flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-8">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 text-sm mt-1">Accede a tu cuenta de FinanziaStock Pro</p>
        </div>
        ...
        <div className="relative mb-6">
          ...
          <div className="relative flex justify-center text-sm"><span className="px-4 bg-white text-gray-400">o con email</span></div>
        </div>
        ...
        <form className="space-y-4" onSubmit={(e) => { e.preventDefault(); window.location.href = "/dashboard"; }}>
          ...
          <div className="flex items-center justify-between text-sm">
            ...
            <a href="#" className="text-[#0078B4] hover:underline">¿Olvidaste tu contraseña?</a>
          </div>
          <button type="submit" className="w-full bg-[#003366] text-white rounded-xl py-3 font-semibold hover:bg-[#001a33] transition">
            Iniciar Sesión
          </button>
        </form>
